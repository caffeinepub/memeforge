...
export class Backend implements backendInterface {
    ...
    async addComment(arg0: MemeId, arg1: string): Promise<CommentId> {
        if (this.processError) {
            try {
    ...
    async createMemePost(arg0: MemePostDTO): Promise<MemeId> {
        if (this.processError) {
            try {
                const result = await this.actor.createMemePost(await to_candid_MemePostDTO_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateMemeSuggestions(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateMemeSuggestions(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllMemes(): Promise<Array<MemePost>> {
        if (this.processError) {
            try {
    ...
    async getCallerUserProfile(): Promise<MemeProfile | null> {
        if (this.processError) {
            try {
    ...
    async getCommentsForMeme(arg0: MemeId): Promise<Array<Comment>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCommentsForMeme(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMemesByUser(arg0: Principal): Promise<Array<MemePost>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemesByUser(arg0);
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserProfile(arg0: Principal): Promise<MemeProfile | null> {
        if (this.processError) {
            try {
    ...
    async likeMeme(arg0: MemeId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.likeMeme(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCallerUserProfile(arg0: MemeProfile): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_MemePost_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MemePost): Promise<MemePost> {
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MemeProfile]): MemeProfile | null {
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MemePost>): Promise<Array<MemePost>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MemePost_n14(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_MemePostDTO_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MemePostDTO): Promise<_MemePostDTO> {
